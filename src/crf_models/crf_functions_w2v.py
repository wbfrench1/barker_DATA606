...
def word2features_w2v_kmeans_clstr(l_sent: list, i: int, dict_word_cluster: dict) -> dict:
...
def sent2features_w2v_kmeans_clstr(l_sent:list, dict_word_cluster: dict ) -> list:
    ...
    return [ word2features_w2v_kmeans_clstr(l_sent, i, dict_word_cluster) for i in range(len(l_sent))]
